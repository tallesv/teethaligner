...
const contencaoFormSchema = yup.object().shape({
...
export default function Contencao() {
  ...
  const {
    ...
    clearErrors,
    getValues,
  } = useForm<ContencaoFormData>({
    resolver: yupResolver(contencaoFormSchema),
    defaultValues: {
  ...
  async function handleTransferenciaVirtualSubmit(data: ContencaoFormData) {
    try {
