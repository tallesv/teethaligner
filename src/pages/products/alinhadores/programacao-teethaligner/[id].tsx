              ...
              <div className="border-t border-gray-200">
                <Tab.Panel hidden={tabSelected !== 'Dados da requisição'}>
                  <dl>
                    ...
                    <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      <dt className="mb-2 sm:mb-0 text-sm font-medium text-gray-600">
                        Informação relevante sobre como deseja que o tratamento
                        ocorre
                      </dt>
                      <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        ...
                        <ul className="divide-y divide-gray-200 rounded-md border border-gray-200">
                          <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                            <div className="flex w-0 flex-1 items-center">
                              ...
                              <span className="ml-2 w-0 flex-1 truncate">
                                {request?.logomarca.slice(73)}
                              </span>
                            </div>
                            <div className="ml-4 flex-shrink-0">
                              <a
                                href={request?.logomarca}
                                target="_blank"
                                className="font-medium text-blue-600 hover:text-blue-500"
                                rel="noreferrer"
                              >
                    ...
                    <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      ...
                      <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {request?.mensagem_personalizada_embalagem}
                      </dd>
                    </div>
                    <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      <dt className="mb-2 sm:mb-0 text-sm font-medium text-gray-600">
